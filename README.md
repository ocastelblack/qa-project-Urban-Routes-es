...
Las pruebas verifican el comportamiento de la interfaz desde la configuración de la ruta hasta la asignación del conductor, utilizando Selenium y Pytest bajo el patrón Page Object Model (POM).
